...
setwd('meta/demodata/MTBLS1267')
test <- readISAtab()
metadata <- test@study.files$MTBLS1267
# change the file name to load in the metabolites data
data0 <- read.table(file = 'm_mtbls1267_NEG_HILIC_mass_spectrometry_v2_maf.tsv', sep = '\t',header = T)
head <- read.table(file = 'm_mtbls1267_NEG_HILIC_mass_spectrometry_v2_maf.tsv',sep = '\t',nrows = 1)
...
rt <- data0[,head=='retention_time']*60
# construnt the list
list <- list(data=data,group=group,mz=mz,rt=rt)
